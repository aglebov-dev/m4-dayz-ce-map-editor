...
from core.areaflags import AreaFlags, _tier_bits
...
def build_areaflags(project: CeProject) -> AreaFlags:
    ...
    return AreaFlags(
        ...
        # заголовок пишем с usage_bits=32, ширину tier берём по числу value-флагов —
        # так же, как её вывел бы ридер, иначе сохранение выдаст другую раскладку
        usage_bytes=4, tier_bits=_tier_bits(list(project.values)),
