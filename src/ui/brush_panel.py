...
class BrushLayerList(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.layer_selected.connect(self.set_active)   # выбор строки -> она активна
...
class BrushPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # инструмент: клик сразу включает режим рисования (см. _on_tool)
        ...
        # применение контура фигуры (Пробел / Esc)
        ...
        # свой список слоёв для выбора слоя рисования (внизу, растягивается)
    ...
    def _on_tool(self, b):
        ...
        if not self.sw_mode.isChecked():
            self.sw_mode.setChecked(True)        # -> mode_toggled(True)
