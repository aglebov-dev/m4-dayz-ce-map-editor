...
ITEM_LAYER_COLOR = (255, 64, 200)                # слой «где может лежать предмет»
...
class ItemsPresenter(QObject):
    ...
    def __init__(self, parent, *, view, buildings: Callable, building_opacity: Callable,
        ...
        self._view = view
        self._buildings = buildings                  # callable -> BuildingsModel | None
        self._building_opacity = building_opacity     # callable -> float
